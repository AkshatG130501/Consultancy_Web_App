...
export const testimonials: Testimonial[] = [
  {
    quote:
      "Northbridge set up our finance function from scratch and ran it better than most in-house teams we'd worked with. Their reporting gave our board confidence within the first quarter.",
  ...
  {
    quote:
      "As a candidate placed through Northbridge, their process was the most professionally run search I've been part of — clear communication at every stage, from screening to offer.",
